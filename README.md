...
* 5.其他一些个人觉得有用的小功能, java 类上添加 "Convert to JSON" 功能，格式化 json 数据 ( *Windows*: `Ctrl + Enter`; *Mac*: `Command + Enter` )。  
 ...
 ### 版本历史
 - **2.1.19**: 更新作者信息为billyle，保留原作者jinghong署名
 - **2.1.18**: 修复Feign接口图标显示问题，正确区分Feign服务和普通Rest服务的图标，在快速搜索框中添加服务类型筛选功能（Rest/Feign/All）
 - **2.1.17**: 新增Feign客户端支持，扩展RESTful服务发现能力，优化服务解析器架构，提升多框架兼容性
 - **2.1.16**: 修复线程安全问题：解决"Save settings failed"错误，getState()方法现在正确处理非EDT线程调用
